...
public class RenderConnectedBlock implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ConnectedTexturesRenderer renderCTBlock = new ConnectedTexturesRenderer(block, world.getBlockMetadata(x, y, z), renderer);
        return renderCTBlock.renderStandardBlock(world, x, y, z);
    }
